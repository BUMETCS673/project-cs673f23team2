...
export default function VideoComponent(props) {
	...
	function getYoutubeVideosFromQuery(keyword) {
		axios.get("https://www.googleapis.com/youtube/v3/search?key=" + "AIzaSyCmfbtelCSnTCkYyI0ZyAUSr2-mEtq65XQ" + "&q=" + keyword + "&type=video&part=snippet&maxResults=3").then((response) => {
